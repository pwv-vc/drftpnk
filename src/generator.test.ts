...
const personaWithUserPrompts: Persona = {
  ...
  prompts: {
    "blog-post": {
      outline:
        "Outline for {{persona_name}} on {{topic}} with theme {{theme}}. Goals: {{goals}}. Do not: {{do_not}}.",
      content:
        "Content for {{persona_name}} ({{persona_id}}) - {{persona_description}}. Outline: {{outline}}.",
    },
  },
};
