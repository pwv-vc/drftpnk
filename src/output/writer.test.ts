...
describe('autoDetectOutlinePath', () => {
  ...
  it('uses the actual idea file base name, not a hardcoded "idea" prefix', () => {
    expect(autoDetectOutlinePath('drftpnk.readme.md', 'blog-post')).toBe('drftpnk.readme.blog-post.outline.md')
  })
  ...
  it('works for tweet content type', () => {
    expect(autoDetectOutlinePath('drftpnk.readme.md', 'tweet')).toBe('drftpnk.readme.tweet.outline.md')
  })
